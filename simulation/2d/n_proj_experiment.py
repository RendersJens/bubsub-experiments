...
for n_proj in range(10, 310, 10):
    ...
    np.save(f"data/n_proj_experiment_{realisation}/fbp_rec{n_proj}", fbp_rec)
    ...
    np.save(f"data/n_proj_experiment_{realisation}/rec{n_proj}", rec)
