...
for I0 in tqdm(vals):
    ...
    fdk_rec = np.load(f"data/noise_experiment_{realisation}/fdk_rec{I0}.npy")
    ...
    phantom = gt_vol
    rec_mesh = trimesh.load(f"data/noise_experiment_{realisation}/rec{I0}.stl")
    ...
    print(f"fbp error at {I0} photons:", fdk_dice)
    # if True: #n_proj == 100:
    #     # plt.figure()
...
np.save(f"data/noise_experiment_{realisation}/fdk_errs", np.array(fdk_errs))
