...
plt.figure()
plt.imshow(gt_vol[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/gt.png", gt_vol[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(rec[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/rec25.png", rec[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(lsqr_rec[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/lsqr_rec25.png", lsqr_rec[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(fdk_rec[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/fdk_rec25.png", fdk_rec[rec.shape[0]//2, :, :], cmap="gray")
...
plt.figure()
plt.imshow(gt_diff[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/gt_diff.png", gt_diff[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(rec_diff[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/rec_diff25.png", rec_diff[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(lsqr_rec_diff[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/lsqr_rec_diff25.png", lsqr_rec_diff[rec.shape[0]//2, :, :], cmap="gray")

plt.figure()
plt.imshow(fdk_rec_diff[rec.shape[0]//2, :, :], cmap="gray")
plt.imsave("images/fdk_rec_diff25.png", fdk_rec_diff[rec.shape[0]//2, :, :], cmap="gray")
