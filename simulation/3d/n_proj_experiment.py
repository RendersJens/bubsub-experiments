...
if not os.path.exists(f"data/n_proj_experiment_{realisation}"):
   os.makedirs(f"data/n_proj_experiment_{realisation}")

for n_proj in range(3, 103, 6):
    ...
    np.save(f"data/n_proj_experiment_{realisation}/lsqr_rec{n_proj}", lsqr_rec)
    ...
    np.save(f"data/n_proj_experiment_{realisation}/fdk_rec{n_proj}", fdk_rec)
    ...
    trimesh.exchange.export.export_mesh(mesh, f"data/n_proj_experiment_{realisation}/rec{n_proj}.stl")